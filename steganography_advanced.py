# use this to work this file "python steganography_advanced.py --help"
# to encode python steganography_advanced.py -e image.PNG -t "This is some secret data."
# to decode python steganography_advanced.py -d encoded_image.PNG
import cv2
import numpy as np
import os
